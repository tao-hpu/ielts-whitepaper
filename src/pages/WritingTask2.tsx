...
export function WritingTask2() {
  return (
    ...
    >
      ...
      <h2><span className="h2-en">Why templates fail</span>为什么背模板必翻车</h2>
      <p>市面上的"万能模板"产品，宣称模板句能覆盖全文的 <b>70–85%</b>，剩下的空按题目填。这恰恰是它的死穴：<span className="kw">模板占比是可测量的——你能量出来，考官也能。</span>三个必然露馅的特征：</p>
      <ul className="tight">
        <li><b>语义错位</b>：模板句是为另一个语境写的，硬塞进新题后介词、搭配、指代都悬空——句子越华丽、和上下文越脱节，越扎眼。</li>
        <li><b>套话空转</b>：大量"放之四海而皆准"的短语不承载题目的具体信息——任务回应（TR）维度直接失血。</li>
        <li><b>篇篇同构</b>：段落结构、让步位置、连接词一模一样，换个题只换名词。</li>
      </ul>
      <Note tag="官方白纸黑字">
        这不是吓唬人：官方《写作评分标准》公开版里，<b>Band 0 的判定条件之一就是
        "writes a totally memorised response"</b>——通篇背诵，直接零分档。
        分界线要划清：<b>骨架可以复用</b>（上面的四段结构就是骨架），<b>句子必须现场长出来</b>。
      </Note>
