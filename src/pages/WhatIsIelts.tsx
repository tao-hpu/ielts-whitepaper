...
export function WhatIsIelts() {
  return (
    ...
    >
      ...
      <p>四项总时长约 <strong>2 小时 45 分</strong>。口语常安排在笔试同一天或前后几天，是真人考官一对一。</p>

      <h2><span className="h2-en">Computer vs Paper</span>机考还是纸考</h2>
      <p>内容、难度、评分完全一样，只是答题介质不同。<strong>机考</strong>出分快（3–5 天）、可随时改答案、听力只给较短的答案确认时间；<strong>纸考</strong>要手写、听力结束后有 10 分钟专门誊写答题卡。按你打字 vs 手写哪个更顺手来选，别纠结难度差异——没有。</p>
